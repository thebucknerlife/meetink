...
final class MeetingsViewController: NSViewController, NSTableViewDataSource,
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Right-aligned group: search, then the Profiles button at
            // the bar's trailing edge.
            searchField.leadingAnchor.constraint(greaterThanOrEqualTo: bar.leadingAnchor, constant: 8),
            ...
            profilesButton.trailingAnchor.constraint(equalTo: bar.trailingAnchor, constant: -8),
